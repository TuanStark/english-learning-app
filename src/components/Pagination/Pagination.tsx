...
export default function Pagination({
    ...
    return (
        <div className="flex items-center justify-center gap-[10px] mt-[40px]">
            {/* Nút Previous */}
            <button
                className="w-[40px] h-[40px] flex items-center justify-center border border-gray-200 rounded-[8px] hover:border-primary-500"
            ...
            {getPageNumbers().map((pageNum, index) => (
                <button
                    ...
                    className={`w-[40px] h-[40px] flex items-center justify-center rounded-[8px] text-[16px] font-medium
                        ${
                            pageNum === page
                                ? 'bg-blue-500 text-white border border-primary-500'
                                : 'border border-primary-500 text-blue-500'
                        }`}
                    onClick={() =>

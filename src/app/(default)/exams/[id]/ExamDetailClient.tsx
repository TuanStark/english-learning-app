...
export default function ExamDetailClient({ exam }: ExamDetailClientProps) {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            {/* Practice Mode Card */}
            <Card className="border-0 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl shadow-xl text-white">
              <CardContent className="p-6 text-center">
                <div className="mb-6">
                  <div className="bg-white/20 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-4">
                    <Brain className="h-10 w-10" />
                  </div>
                  <h3 className="text-xl font-bold mb-2">Chế độ thực hành</h3>
                  <p className="text-green-100 text-sm">
                    Luyện tập không giới hạn thời gian với AI hỗ trợ
                  </p>
                </div>
                ...
                <Button
                  asChild
                  size="lg"
                  className="w-full bg-white text-green-600 hover:bg-gray-100 rounded-xl font-semibold py-3"
                >

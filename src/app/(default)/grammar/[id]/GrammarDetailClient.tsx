...
import { type Grammar } from '@/lib/api'

interface GrammarDetailClientProps {
  grammar: Grammar
}

export default function GrammarDetailClient({ grammar }: GrammarDetailClientProps) {
  ...
  useEffect(() => {
    const findGrammarExam = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/exams?type=GRAMMAR&search=${grammar.title}`)
        if (response.ok) {
          const data = await response.json()
          const exam = data.data?.find((e: any) => e.title.includes(grammar.title || ''))
          if (exam) {
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-2 text-lg">
                    {grammar.content.substring(0, 100)}...
                  </p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-gray-900">{grammar.orderIndex}</div>
            ...
            <div className="relative bg-white/80 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
              ...
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-6">
                  <Badge className={`${getDifficultyColor(grammar.difficultyLevel)} px-4 py-2 text-lg`}>
                    {grammar.difficultyLevel}
                  </Badge>
                </div>
                ...
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-2xl border-l-4 border-blue-500 mb-6">
                    ...
                    <p className="text-lg leading-relaxed">{grammar.content}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-2xl border-2 border-green-200">
                    <div className="mb-4">
                      ...
                      <p className="text-gray-700">
                        Hãy viết một câu sử dụng {grammar.title.toLowerCase()} để diễn tả một hành động đã hoàn thành.
                      </p>
                    </div>
                    ...
                    {showAnswer && (
                      <div className="mt-4 p-4 bg-white rounded-xl border border-green-200">
                        ...
                        <p className="text-sm text-gray-600 mt-2">
                          Đây là một ví dụ điển hình sử dụng {grammar.title.toLowerCase()}.
                        </p>
                      </div>
                    )}
                  </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <Card className="border-2 border-orange-200 hover:border-orange-300 transition-colors">
                      ...
                      <CardContent>
                        <p className="text-gray-700 mb-4">
                          Hoàn thành câu bằng cách sử dụng {grammar.title.toLowerCase()}.
                        </p>
                    ...
                    <Card className="border-2 border-orange-200 hover:border-orange-300 transition-colors">
                      ...
                      <CardContent>
                        <p className="text-gray-700 mb-4">
                          Viết 3 câu sử dụng {grammar.title.toLowerCase()}.
                        </p>
                        <Button variant="outline" className="w-full">
                          Bắt đầu
                        </Button>

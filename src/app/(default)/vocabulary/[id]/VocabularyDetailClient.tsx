...
import { type Vocabulary, type VocabularyTopic } from '@/lib/api'

interface VocabularyDetailClientProps {
  topic: VocabularyTopic
}

export default function VocabularyDetailClient({ topic }: VocabularyDetailClientProps) {
  const { 
    vocabularies, 
    loading, 
    error, 
